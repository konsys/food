  ...
  <main className='page-content'>
    ...
    <div itemScope itemType='https://schema.org/ItemList' className='hidden'>
      ...
      <div itemProp='itemListElement' itemScope itemType='https://schema.org/ListItem'>
        ...
        <meta itemProp='position' />
        <a itemProp='url' href='https://broniboy.ru/nn/restaurants/p_khachapuri-tetushki-mariko/' />
      </div>
      <div itemProp='itemListElement' itemScope itemType='https://schema.org/ListItem'>
        ...
        <div className='restaurants-body'>
          <div className='row'>
            ...
            <div className='col-lg-4 col-md-6 col-sm-6 col-xs-12'>
              ...
              >
                <div className='restaurant-box-top'>
                  <a href='https://broniboy.ru/nn/restaurants/p_coffee-cake/' title='Coffee Cake'>
                    <img
            ...
            <div className='col-lg-4 col-md-6 col-sm-6 col-xs-12'>
              ...
              >
                <div className='restaurant-box-top'>
                  <a href='https://broniboy.ru/nn/restaurants/p_iula-pitstsa/' title='Юла Пицца'>
                    <img
              ...
              >
                ...
                <div className='restaurant-box-second'>
                  <a
                    ...
                    title='Та самая шаурма на Средном'
                  >
                    <div className='restaurant-box-second__title'>Та самая шаурма на Средном</div>
                  </a>
                  <div className='restaurant-box-second__description'>
                    <div className='restaurant-box-second__delivery'>
                      <div>
