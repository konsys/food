...
export const Header: FC = () => (
  <Row className='headerWrapper' align='middle'>
    <Col span={24}>
      <Row className='header' align='middle'>
        <Col span={12}>
          <Row className='leftHeader' align='middle'>
            <Col className='logo' span={8}>
              <img src='https://broniboy.ru/img/content/logo/main-logo.svg' alt='Broniboy' />
            </Col>
            <Col>
              <svg
                width='24'
