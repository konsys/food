      ...
      <div className="restaurant-descr--mobile">
        <div>
          <div className="restaurant-descr__delivery_info--mobile delivery_type--long_distance--mobile">
            <img
              src="http://localhost:8000/img/icons/long_distance.svg"
      ...
      <div className="restaurant__info--mobile">
        <div className="container">
          <div className="delivery_type__title--mobile">
            ...
            <div className="delivery_type__price delivery_type__price--long_distance">
              190 ₽
            </div>
          </div>
          <p className="delivery_type__description--mobile">
            Ваш заказ будет доставлен курьерами Broniboy. Ресторан находится
            далеко от вашего адреса, поэтому доставка может занять более 40
            минут.
          </p>
        </div>
      </div>
